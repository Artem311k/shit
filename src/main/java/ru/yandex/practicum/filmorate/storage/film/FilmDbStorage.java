...
public class FilmDbStorage implements FilmStorage {
    ...
    private Set<Long> getAllLikesOfFilm(Long filmId) {
        String sqlQuery = "SELECT users from likes_list where film =?";
        List<Long> list = jdbcTemplate.query(sqlQuery, new BeanPropertyRowMapper<>(Long.class), filmId);
    ...
    private Film makeFilm(ResultSet rs) throws SQLException {
        ...
        Set<Long> likes = getAllLikesOfFilm(id);
        Mpa mpa = new Mpa(
                rs.getLong("mpa_id"),
